...
(function () {
  ...
  /* ------------------------------------------------------------------
     Demo provider data.
     level: supervisor | certified | associate
  ...
  var PROVIDERS = [
    ...
    {
      name: "Dr. Bilal Hutchinson", credentials: "PsyD · Clinical Psychologist", level: "supervisor",
    ...
    {
      name: "Dr. Rania Khalil", credentials: "PhD · Counseling Psychology", level: "supervisor",
    ...
    {
      name: "Maryam Siddiqui", credentials: "LMFT · Marriage & Family Therapist", level: "certified",
    ...
    {
      name: "Khadija Mohamed", credentials: "LICSW · Clinical Social Worker", level: "certified",
    ...
    {
      name: "Dr. Tariq Aziz", credentials: "R.Psych · Registered Psychologist", level: "certified",
    ...
    {
      name: "Sofia Begum", credentials: "BABCP Accredited CBT Therapist", level: "certified",
    ...
    {
      name: "Fatima Patel", credentials: "MA Clin Psych · Clinical Psychologist", level: "certified",
    ...
    {
      name: "Ahmad Chaudhry", credentials: "LPC-Associate (supervised)", level: "associate",
    ...
    {
      name: "Ibrahim Diallo", credentials: "MHC-LP · Mental Health Counselor", level: "associate",
    ...
    {
      name: "Nadia Bouchard", credentials: "RP (Qualifying) · Psychotherapist", level: "associate",
    ...
    {
      name: "Hafiz Roslan", credentials: "Registered Counsellor (LKM)", level: "associate",
    ...
    {
      name: "Zayd Ibrahim", credentials: "Provisional Psychologist", level: "associate",
  ...
  var LEVELS = {
    ...
    certified:  { label: "Certified Clinician", cls: "lv-certified" },
    associate:  { label: "Associate · In Training", cls: "lv-associate" }
  };
  ...
  function matches(p) {
    ...
    if (q) {
      var hay = [p.name, p.credentials, p.bio, p.city, p.state || "", p.country,
  ...
  clearBtn.addEventListener("click", function () {
    selCountry.value = ""; selSpec.value = ""; inputQ.value = "";
    refreshStateOptions();
    refreshCityOptions();
    render();
  });
